/*
 * KinectModelControllerV2.cs - Handles rotating the bones of a model to match 
 * 			rotations derived from the bone positions given by the kinect1
 * 
 * 		Developed by Peter Kinney -- 2011/06/30
 *  	Modified by ほえたん(Hoetan) -- 2015/08/07
...
public class KinectModelControllerV2 : MonoBehaviour {
	...
	public FBXExporter4Unity sFBXExporter4Unity;
	...
	void Start () {
        ...
        {
            sFBXExporter4Unity.bOutAnimation = false;
            sFBXExporter4Unity.bOutAnimationCustomFrame = true;
        }
