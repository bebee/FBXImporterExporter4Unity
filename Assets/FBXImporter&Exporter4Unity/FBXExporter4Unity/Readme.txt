...
FBX Exporter 4 Unity β Version 2015/08/07
...
※「DllNotFoundException: Assets/FBXImporter&Exporter4Unity/FBXExporter4Unity/Plugins/x86_64/FBXExporter4Unity.dll」のエラーがでた場合は、上記のランタイムのインストールが必須です。
...
※「DllNotFoundException: Assets/FBXImporter&Exporter4Unity/FBXExporter4Unity/Plugins/x86_64/FBXExporter4Unity.dll」のエラーがでた場合は、上記のＳＤＫにあるＤＬＬのコピーが必須です。
...
　FBX Exporterを使用したい場合は、Unity Editor上で、「Assets/FBXImporter&Exporter4Unity/FBXExporter4Unity/Scenes/FBXExporter4Unity.unity」のシーンを開いてから実行（再生）してください。
　Kinect1を使用したい場合は、Unity Editor上で、「Assets/FBXImporter&Exporter4Unity/FBXExporter4Unity/Scenes/UnityKinect1ToFBX.unity」のシーンを開いてから実行（再生）してください。
　Kinect2を使用したい場合は、Unity Editor上で、「Assets/FBXImporter&Exporter4Unity/FBXExporter4Unity/Scenes/UnityKinect2ToFBX.unity」のシーンを開いてから実行（再生）してください。
　新規シーンの場合は、Hierarchyの「Main Camera」に「Assets/FBXImporter&Exporter4Unity/FBXExporter4Unity/Scripts/FBXExporter4Unity.cs」のスクリプトをアタッチしてから実行（再生）してみてください。
　実行（再生）すると、プロジェクトのルートディレクトにデフォルトのファイル名「Unity.fbx」が自動生成されます。
　FBXファイルは、3ds Max 2016 / Maya 2016 / Softimage 2015 / MotionBuilder 2016に対応しています。
...
*If it is a new scene, attach the following script, “Assets/FBXImporter&Exporter4Unity/FBXExporter4Unity/Scripts/FBXExporter4Unity.cs”, to the “Main Camera” found in the Hierarchy.
